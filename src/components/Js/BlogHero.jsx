    ...
    <>
      <section className="BlogHero">
        <div className="BlogHero-container">
          <Topnav />
          <Navi />
          <div className="BlogHero-content d-flex justify-content-center align-items-center">
            <div className="BlogHero-content__text d-flex flex-column justify-content-center align-items-center">
              <h1 className="BlogHero-heading ">{title}</h1>
              {/* <svg
